...
function whereToHit(bodypart) {
    var whatDoing;
    switch (bodypart) {
        case "head":
            whatDoing = "you did a headshot";
            break;
        case "back":
            whatDoing = "dirty trickster hobbit";
            break;
        case "knee":
            whatDoing = "he took an arrow to the knee";
            break;
        default:
            whatDoing = "enter valid body part"
    }
    return whatDoing;
}